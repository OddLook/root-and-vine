        ...
        <div className="grid grid-cols-4 gap-12 pb-14 border-b border-white/10">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex gap-3 mt-1">
              <a href="#" aria-label="Instagram" className="w-11 h-11 flex items-center justify-center rounded-full border border-white/20 hover:border-[#76974a] transition-colors">
              ...
              <a href="#" aria-label="TikTok" className="w-11 h-11 flex items-center justify-center rounded-full border border-white/20 hover:border-[#76974a] transition-colors">
                <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z" />
                </svg>
              </a>
              <a href="#" aria-label="Pinterest" className="w-11 h-11 flex items-center justify-center rounded-full border border-white/20 hover:border-[#76974a] transition-colors">
                <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {Object.entries(links).map(([heading, items]) => (
            <div key={heading} className="flex flex-col gap-4">
              ...
              <ul className="flex flex-col gap-3">
                {items.map(item => (
                  <li key={item}>
                    <a href="#" className="text-white/50 text-sm hover:text-[#76974a] transition-colors cursor-pointer">
                      {item}
                    </a>
                  </li>
                ))}
